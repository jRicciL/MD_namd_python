...
# Selecciona todos los atomos de todos los frames
...
set prot [[atomselect top "protein and alpha"] get resid]
set output [open residue_rmsf.dat w]
set i 1
foreach res $prot {
	#Selecciona el carbono alfa del residuo
	set resAlpha [atomselect top "protein and alpha and resid $res"]
