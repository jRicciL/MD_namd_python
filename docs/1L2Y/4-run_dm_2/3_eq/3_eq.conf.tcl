...
## Ahora si se utiliza un archivo restart, el del SA
set restart        ../2_sa/${inputname}_sa

## Nombre de los archivos de salida
outputName         ./${inputname}_eq
...
##	Ejecuta para 5 ns = 2500000 pasos
run 2500000
